...
HDL_ATTRACTIONS = %w(attJungleRiverCruise attTarzansTreehouse attRafttoTarzansTreehouse attBigGrizzlyMountainRunawayMineCars attRCRacer attSlinkyDogSpin attToySoldierParachuteDrop attIronManExperience attOrbitron attStarWarsCommandPost attHyperspaceMountain attitsasmallworld attTheManyAdventuresofWinniethePooh attCinderellaCarousel attFairyTaleForest attMadHatterTeaCups attMickeysPhilharMagic attDumbotheFlyingElephant attMysticManor attAnimationAcademy attArtofAnimation attMainStreetVehicles attHongKongDisneylandRailroadMainStreetStation)
...
HDL_MAIN_ATTRACTIONS = %w(attIronManExperience attHongKongDisneylandRailroadMainStreetStation attTheManyAdventuresofWinniethePooh attDumbotheFlyingElephant attitsasmallworld attMickeysPhilharMagic attHyperspaceMountain attJungleRiverCruise attRCRacer attSlinkyDogSpin attToySoldierParachuteDrop attBigGrizzlyMountainRunawayMineCars attMysticManor)
